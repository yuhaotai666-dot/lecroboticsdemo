export const en: Record<string, string> = {
  ...
  "home.cap1.title": "Commercial distribution",
  "home.cap1.body": "We select, position and deploy the right machine for your operation — not the one that happens to be in stock.",
  "home.cap2.title": "Software & localisation",
  "home.cap2.body": "UK-governed architecture and Western compliance standards, configured for how your site actually runs.",
  "home.cap3.title": "Ecosystem design",
  "home.cap3.body": "Your building, workflows and integrations rebuilt around autonomous machines, not bolted on beside them.",
  "home.cap4.title": "Data & training",
  "home.cap4.body": "Mapping, routing and operational data that make a robot capable on day one rather than month six.",
  "home.cap5.title": "Intelligence systems",
  "home.cap5.body": "Layered LLM and LAM architecture so your team manages outcomes, not machines.",
  "home.cap6.title": "Manufacturing",
  "home.cap6.body": "Prototype to commercial scale. UKCA certified, CE marked, proven in live environments.",
