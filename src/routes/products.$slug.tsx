    ...
    <>
      <section className="border-b border-border">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-14 lg:grid-cols-2">
          <div className="flex items-center justify-center rounded-sm border border-border bg-card p-10">
          ...
          <div>
            ...
            <h1 className="mt-4 text-4xl font-extrabold md:text-5xl">{p.name}</h1>
            ...
            <div className="mt-8 grid gap-px overflow-hidden rounded-sm border border-border bg-border sm:grid-cols-2">
              <div className="bg-background p-5">
                ...
                <p className="mt-2 font-display text-3xl font-extrabold">{formatPrice(p)}</p>
                <p className="mt-1 text-xs text-muted-foreground">+ VAT</p>
              </div>
              <div className="bg-background p-5">
                <p className="label-mono text-muted-foreground">Finance</p>
                <p className="mt-2 font-display text-3xl font-extrabold">{p.finance ?? "On request"}</p>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-5 py-16">
          <h2 className="text-3xl font-extrabold">Specification</h2>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-5 py-16">
          <h2 className="text-3xl font-extrabold">What deployment looks like</h2>
      ...
      <section>
        <div className="mx-auto max-w-7xl px-5 py-16">
          <div className="flex items-end justify-between gap-4">
            <h2 className="text-3xl font-extrabold">Explore other robots</h2>
