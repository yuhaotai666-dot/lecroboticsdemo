  ...
  head: ({ params }) => ({
    meta: [
      ...
      { property: "og:title", content: "Case Studies | LEC Robotics" },
      {
        ...
        content: "Robots at work in real venues, across ten industries.",
      },
    ],
    links: headLinks("/case-studies", localeFromParams(params)),
  }),
...
const studies: Study[] = [
  {
    id: "hotel-delivery",
    key: "cases.s1",
    industryKey: "ind.hospitality.name",
    filter: "hospitality",
    robots: ["butlerbot-w3"],
  },
  {
    ...
    key: "cases.s2",
    industryKey: "ind.food-and-beverage.name",
  ...
  },
  {
    ...
    key: "cases.s5",
    industryKey: "ind.health-care.name",
    filter: "health-care",
  ...
  },
  {
    id: "venue-coffee",
    key: "cases.s7",
    industryKey: "case.public-service",
...
function CaseStudies() {
  ...
  return (
    <>
      <section
        id="featured"
        className="scroll-mt-24 border-b border-border bg-gradient-to-b from-accent/60 to-background"
      >
      ...
      <div className="mx-auto max-w-6xl px-5 pt-10">
        ...
        {shown.length === 0 ? (
          <p className="py-16 text-center text-sm text-muted-foreground">
            {t("cases.empty")}{" "}
            <LocaleLink to="/book-a-demo" className="font-medium text-primary">
              {t("cases.talkToUs")}
            </LocaleLink>{" "}
            {t("cases.emptySuffix")}
          </p>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-7">
                    ...
                    <p className="mt-1.5 text-sm text-muted-foreground">
                      {t(s.industryKey)} ·{" "}
                      {s.robots.map((r) => products.find((p) => p.slug === r)?.name).join(" · ")}
                    </p>
